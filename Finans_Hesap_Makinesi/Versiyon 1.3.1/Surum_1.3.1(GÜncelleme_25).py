...
def birikimli_f4():
        ...
        #Çıktı
        sonuc=Label(birikimli_4,text="SONUÇ",font="Courier 16 bold",bg="#85bfcd")
        sonuc.place(x=180,y=200)
        #Etiketler
        #Etiketler
        etiket_Anapara=tk.Label(birikimli_4,text="Anapara : ",font="Courier 10 bold",bg="#85bfcd")
        etiket_Zaman=tk.Label(birikimli_4,text="Zaman : ",font="Courier 10 bold",bg="#85bfcd")
        etiket_iskonto=tk.Label(birikimli_4,text="İskonto Oranı : ",font="Courier 10 bold",bg="#85bfcd")
        etiket_Anapara.place(x=64,y=50)
        etiket_Zaman.place(x=79,y=85)
        etiket_iskonto.place(x=15,y=115)
        #Veri Girişi
        Anapara=tk.Entry(birikimli_4,font="Courier 16 bold",width=10,justify="center")
        Zaman=tk.Entry(birikimli_4,font="Courier 16 bold",width=10,justify="center")
        Iskonto_Orani=tk.Entry(birikimli_4,font="Courier 16 bold",width=10,justify="center")
        Anapara.place(x=140,y=50)
        Zaman.place(x=140,y=80)
        Iskonto_Orani.place(x=140,y=110)
        #Butonlar
        hesap=Button(birikimli_4,text="Hesapla",font="Courier 10 bold",command=bileşik_iskonto)
        temiz=Button(birikimli_4,text="Temizle",font="Courier 10 bold",command=temizle)
        hesap.place(x=290,y=50)
        temiz.place(x=290,y=80)
...
def birikimli_f5():
        ...
        def Temizlik ():
                Vr_exp.delete(0,END)
                Vr_faiz.delete(0,END)
                Vr_anapara.delete(0,END)
                Vr_zaman.delete(0,END)

        #Çıktı atama
        sonuc=tk.Label(birikimli_5,text="Sonuç",font="Courier 16 bold",bg="#85bfcd")
        sonuc.place(x=180,y=200)
        #Etiket atama
        Etiket_anapara=tk.Label(birikimli_5,text="Anapara :",font="Courier 10 bold",bg="#85bfcd")
        Etiket_Zaman=tk.Label(birikimli_5,text="Zaman :",font="Courier 10 bold",bg="#85bfcd")
        Etiket_Faiz_kuvveti=tk.Label(birikimli_5,text="Faiz Kuvveti :",font="Courier 10 bold",bg="#85bfcd")
        Etiket_Exp=tk.Label(birikimli_5,text="Exp. :",font="Courier 10 bold",bg="#85bfcd")
        Etiket_anapara.place(x=75,y=50)
        Etiket_Zaman.place(x=90,y=80)
        Etiket_Faiz_kuvveti.place(x=35,y=110)
        Etiket_Exp.place(x=100,y=140)
        # Veri Girişleri
        Vr_anapara=tk.Entry(birikimli_5,font="Courier 16 bold",justify="center",width=10)
        Vr_zaman=tk.Entry(birikimli_5,font="Courier 16 bold",justify="center",width=10)
        Vr_faiz=tk.Entry(birikimli_5,font="Courier 16 bold",justify="center",width=10)
        Vr_exp=tk.Entry(birikimli_5,font="Courier 16 bold",justify="center",width=10)
        Vr_anapara.place(x=160,y=50)
        Vr_zaman.place(x=160,y=80)
        Vr_faiz.place(x=160,y=110)
        Vr_exp.place(x=160,y=140)

        # Butonlar
        hesap=Button(birikimli_5,text="Hesapla",font="Courier 10 bold",command=Sabit_Anlik_faiz_orani)
        temiz=Button(birikimli_5,text="Temizle",font="Courier 10 bold",command=Temizlik)
        hesap.place(x=300,y=50)
        temiz.place(x=300,y=80)
...
def birikimli_f6():
        ...
        kurcu.place(x=400,y=280)
        # Fonksiyonlar
        def dönem_sonu_duzenli_odeme():
                s1=float(giris_adet.get())
                s2=float(giris_faiz.get())
                sonuc.configure(text=str((((1+s2)**s1)-1)/s2))
        def temizle():
                giris_adet.delete(0,END)
                giris_faiz.delete(0,END)

        #sonuc
        sonuc=tk.Label(birikimli_6,text="SONUÇ",font="Courier 16 bold",bg="#85bfcd")
        sonuc.place(x=180,y=200)

        #Etiketler
        etiket_faiz=Label(birikimli_6,text="Faiz Oranı :",font="Courier 10 bold",bg="#85bfcd")
        etiket_adet=Label(birikimli_6,text="Ödeme adedi :",font="Courier 10 bold",bg="#85bfcd")
        etiket_faiz.place(x=48,y=50)
        etiket_adet.place(x=40,y=80)
        #Veri Giriş
        giris_adet=Entry(birikimli_6,font="Courier 16 bold",justify="center",width=10)
        giris_faiz=Entry(birikimli_6,font="Courier 16 bold",justify="center",width=10)
        giris_faiz.place(x=150,y=50)
        giris_adet.place(x=150,y=80)
        #butonlar
        hesapla=Button(birikimli_6,text="Hesapla",font="Courier 10 bold",command=dönem_sonu_duzenli_odeme)
        Temizle=Button(birikimli_6,text="Temizle",font="Courier 10 bold",command=temizle)
        hesapla.place(x=300,y=50)
        Temizle.place(x=300,y=80)
def birikimli_f7():
