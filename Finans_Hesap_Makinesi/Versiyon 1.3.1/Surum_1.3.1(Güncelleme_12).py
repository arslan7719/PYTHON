...
mbtn.menu.add_command(label="T Anında t Ödeme Oranlı Sürekli Artan Seri")
mbtn.menu.add_command(label="T Anında n-t Ödeme Oranlı Sürekli Azalan Seri")
mbtn.menu.add_command(label="T Anında t Ödeme Oranlı Sürekli Sonsuz Artan Seri")
mbtn.menu.add_command(label="Net Peşin Değer")
mbtn.menu.add_command(label="İç Verim/Getiri Oranı Karşılaştırma")
mbtn.menu.add_command(label="Nominal ve Gerçek Nakit Akışlarının Peşin Değeri")
mbtn.menu.add_command(label="Para Ağırlıklı Faiz/Getiri Oranı")
