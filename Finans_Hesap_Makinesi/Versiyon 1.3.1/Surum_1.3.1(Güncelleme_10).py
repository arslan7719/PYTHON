...
mbtn.menu.add_command(label="Dönem Sonu Sonsuz Artan Ödemeler Serisi")
mbtn.menu.add_command(label="Dönem Başı Sonsuz Artan Ödemeler Serisi")
mbtn.menu.add_command(label="Sürekli Ödemeli Artan Ödemeler Serisi")
mbtn.menu.add_command(label="Sürekli Ödemeli Azalan Ödemler Serisi")
mbtn.menu.add_command(label="Sürekli Ödemeli Artan Sonsuz Ödemeler Serisi")
mbtn.menu.add_command(label="Üssel Artan Dönem Sonu Ödemeler Serisi")
mbtn.menu.add_command(label="Üssel Artan Dönem Başı Ödemeler Serisi")
