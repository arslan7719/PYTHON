...
def Donem_sonu_sonsuz_Artan_odemeler_Serisi():
        ...
        def donem_basi_artan_odemeler_serisi():
                s1=float(Vr_adet.get())
                s4=float(Vr_faiz.get())
                sonuc.configure(text=str(s1*(1/s4)))
        ...
        sonuc.place(x=180,y=200)
        #Etiket
        Etiket_adet=Label(pencere_20,text="Para  :",font="Courier 10 bold",bg="#85bfcd")
        Etiket_faiz=Label(pencere_20,text="Faiz oran :",font="Courier 10 bold",bg="#85bfcd")
        Etiket_adet.place(x=80,y=50)
        Etiket_faiz.place(x=50,y=80)
        #veri girişi
        Vr_adet=Entry(pencere_20,font="Courier 16 bold",justify="center",width=10)
        ...
        Vr_faiz.place(x=140,y=80)
        #butonlar
        hesap=Button(pencere_20,text="Hesapla",font="Courier 10 bold",command=donem_basi_artan_odemeler_serisi)
...
def Donem_basi_sonsuz_artan_ödemler_serisi():
        ...
        def donem_basi_azalan_odemeler_serisi():
                ...
                sonuc.configure(text=str(s1*(1/s3)))
        ...
        sonuc.place(x=180,y=200)
        #Etiket
        Etiket_adet=Label(pencere_21,text="Para       :",font="Courier 10 bold",bg="#85bfcd")
        Etiket_iskonto=Label(pencere_21,text="İskonto oran :",font="Courier 10 bold",bg="#85bfcd")
        Etiket_adet.place(x=40,y=50)
        Etiket_iskonto.place(x=25,y=80)
        #veri girişi
        Vr_adet=Entry(pencere_21,font="Courier 16 bold",justify="center",width=10)
        Vr_iskonto=Entry(pencere_21,font="Courier 16 bold",justify="center",width=10)
        Vr_adet.place(x=140,y=50)
        Vr_iskonto.place(x=140,y=80)
        #butonlar
        hesap=Button(pencere_21,text="Hesapla",font="Courier 10 bold",command=Donem_basi_sonsuz_artan_ödemler_serisi)
...
def Surekli_duzenli_odemeler_serisi():
        pencere_22=Toplevel()
        pencere_22.title("Sürekli düzenli ödemeler serisi")
        ...
        Etiket_iskonto=Label(pencere_22,text="İskonto oran :",font="Courier 10 bold",bg="#85bfcd")
...
sub_menu.add_command(label="Sürekli Ödemeli Artan Ödemeler Serisi",command=Surekli_duzenli_odemeler_serisi)
