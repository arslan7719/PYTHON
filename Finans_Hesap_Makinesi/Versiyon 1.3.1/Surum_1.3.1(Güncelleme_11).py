...
mbtn.menu.add_command(label="Sürekli Değişen Nakit Akışı")
...
mbtn.menu.add_command(label="Devam >>")# menu içerisinde 2. sayfa ekleme yöntemi bakılacak.
