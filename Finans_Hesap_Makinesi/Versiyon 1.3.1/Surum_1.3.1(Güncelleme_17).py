...
sub_menu_3.add_command(label="Sürekli Ödemeli Artan Ödemeler Serisi")
sub_menu_3.add_command(label="Sürekli Ödemeli Azalan Ödemeler Serisi")
sub_menu_3.add_command(label="Üssel Artan Dönem Sonu Ödemeler Serisi")
sub_menu_3.add_command(label="Üssel Artan Dönem Başı Ödemeler Serisi")
sub_menu_3.add_command(label="Sürekli Değişken Nakit Akışı")
sub_menu_3.add_command(label="T Anında t Ödeme Oranlı Sürekli Artan Seri")
sub_menu_3.add_command(label="T anında n-t Ödeme Oranlı Sürekli Azalan Seri")
