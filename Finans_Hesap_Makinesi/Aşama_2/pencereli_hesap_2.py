#Bu kod dizininde bir öncekinin üzerine yeni eklemeler yapılarak güncellenmiştir.
#bu sürümde birikimi bilinen fakat anaparanın tahminini yapar duruma geldi.

# pencere oluşturma ve düzenleme.
from tkinter import *
import tkinter as tk 
pencere_1=tk.Tk()
pencere_1.geometry('520x400')#Bu kod Pencere boyuru ayarlıyor.
